...
In this blog post, I'll describe how I set up GnuPG and Org Journal to enable encryption;
...
gpg>
#+end_src
type ~trust~ and then hit {{{kbd(Enter)}}} and choose 5 (ultimate) and then type ~quit~.
That's it!

[fn:1] see the [[https://www.openkeychain.org/faq/][FAQ of the Openkeychain website]] for details.
